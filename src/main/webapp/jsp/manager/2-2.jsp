...
<head>
    <meta charset="UTF-8">
    <title>小说管理</title>
    <link rel="stylesheet" href="../../css/manageNovel.css">
    ...
    <main>
        <div>
            <div id="adbt">
                ...
                <input class="novelSelectInput" type="text" id="novelSelectInput" placeholder="请输入名称查询...">
            </div>
...
<script src="../../js/manageNovel.js"></script>
</body>
</html>
